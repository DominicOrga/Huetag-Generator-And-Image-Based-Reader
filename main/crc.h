...
namespace orga {
	...
	/// <summary>
	/// CRC convolves the bitData with the key and returns the result to outConvolvedData.
	/// <returns> 
	...
	/// <returns> 
	/// Returns 0 if the operation was successful and bitData is accepted.
	/// Returns 1 if the operation was successful but bitData is rejected.
	/// Returns -1 if a non-binary digit input was found which also cancels the function.
	///</returns>
	/// </summary>
